...
Button(root, text="Добавить", command=add, height=3, width=13).place(x=650, y=20)
Button(root, text="Изменить", command=update, height=3, width=13).place(x=650, y=90)
Button(root, text="Уд0лить", command=delete, height=3, width=13).place(x=650, y=160)
