...
#top frames
Label(root,text="Email: stiron_n@mail.ru",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
Label(obj2,text="Fater's Name:",font="arial 13",bg=framebg,fg=framefg).place(x=30,y=50)
